...
public class GetUserActivities
{
    ...
    public class Hander(AppDbContext context, IMapper mapper) : IRequestHandler<Query, Result<List<UserActivityDto>>>
    {
        public async Task<Result<List<UserActivityDto>>> Handle(Query request, CancellationToken cancellationToken)
        {
            ...
            query = request.Filter switch
            {
                ...
                _ => query.Where(a => a.Date >= today && a.Attendees.Any(x => x.IsHost))
            };
